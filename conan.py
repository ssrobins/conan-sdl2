...
def main():
    ...
    platform = {
        "androidarm": "-s os=Android -s os.api_level=16 -s arch=armv7 -s compiler=clang -s compiler.version=9 -s compiler.libcxx=c++_static",
        "androidarm64": "-s os=Android -s os.api_level=21 -s arch=armv8 -s compiler=clang -s compiler.version=9 -s compiler.libcxx=c++_static",
